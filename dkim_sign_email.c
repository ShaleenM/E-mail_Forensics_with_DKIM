...
int main(void)
{
  ...
  for(i =1;i<=10;i++)
  {
      ...
      sprintf(command2048SHA1, "openssl dgst -sha1 -sign rsaprivatekey2048.pem msg%d.txt > ./Output/2048SHA1/cipher%d.txt.sig" , i,i);
      ...
      sprintf(command1024SHA1, "openssl dgst -sha1 -sign rsaprivatekey1024.pem msg%d.txt > ./Output/1024SHA1/cipher%d.txt.sig" , i,i);
      ...
      sprintf(command2048SHA256, "openssl dgst -sha256 -sign rsaprivatekey2048.pem msg%d.txt > ./Output/2048SHA256/cipher%d.txt.sig",i,i);
      ...
      sprintf(command1024SHA256, "openssl dgst -sha256 -sign rsaprivatekey1024.pem msg%d.txt > ./Output/1024SHA256/cipher%d.txt.sig",i,i);
